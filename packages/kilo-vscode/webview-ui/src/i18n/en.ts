export const dict = {
  ...
  // Contract Kit Creator — Studio gates panel
  "studio.gates.summary.passing": "{{passing}} of {{total}} gates passing",
  "studio.gates.summary.score": "score {{score}}",
  "studio.gates.row.whyExpand": "Why this matters",
  "studio.gates.row.whyCollapse": "Hide details",
  "studio.gates.row.whyHeading": "Why this matters.",
  "studio.gates.row.howHeading": "How to fix.",
  "studio.gates.row.applyFix": "Apply suggested fix",
  "studio.gates.row.override": "Override with reason",
  "studio.gates.row.overrideTooltip": "Skip this gate with a written reason. The reason is saved to the audit log.",
  "studio.gates.row.overridePrompt": "Reason for override (audit-logged):",
  "studio.gates.row.overridePlaceholder": "e.g. Risk accepted by Jane Doe — see ADR-0014.",
  "studio.gates.row.overrideSave": "Save override",
  "studio.gates.row.overrideCancel": "Cancel",
  "studio.gates.status.passing": "Passing",
  "studio.gates.status.warn": "Needs attention",
  "studio.gates.status.failing": "Failing",
  "studio.gates.category.truth": "Truth — is the doc honest and consistent?",
  "studio.gates.category.proof": "Proof — can we show the work is done?",
  "studio.gates.category.safety": "Safety — does it handle AI risks?",
  "studio.gates.category.compliance": "Compliance — is it ready for buyers and auditors?",

  // Contract Kit Creator — Empty state
  "studio.empty.title": "Describe what you want to build",
  "studio.empty.subtitle": "Plain English is fine. The studio will ask three follow-up questions, then turn your idea into a contract you can hand to an AI agent.",
  "studio.empty.placeholder": "Example: I want to build a marketplace where people buy and sell vintage cameras…",
  "studio.empty.tryExamples": "Don't know where to start? Try one of these example projects:",
  "studio.empty.example.marketplace": "Marketplace",
  "studio.empty.example.internalTool": "Internal tool",
  "studio.empty.example.mobileApp": "Mobile app",
  "studio.empty.example.aiAssistant": "AI assistant",
  "studio.empty.example.ecommerce": "E-commerce store",
  "studio.empty.example.personalBlog": "Personal blog",
  "studio.empty.cta": "Get started",
  "studio.empty.ctaPending": "Getting started…",
  "studio.empty.privacy": "We never share your idea outside this workspace.",

  // Contract Kit Creator — Sign-off panel
  "studio.signoff.summary": "{{approved}} of {{total}} acceptance items approved",
  "studio.signoff.signingAs": "signing as {{user}}",
  "studio.signoff.notSignedIn": "not signed in",
  "studio.signoff.empty": "No acceptance criteria found in this contract yet. Add a 'Given / When / Then' block and the studio will list it here.",
  "studio.signoff.row.viewTrace": "View test recording",
  "studio.signoff.row.viewTraceTooltip": "Open the recording of the test that backs this acceptance item.",
  "studio.signoff.row.approve": "Approve",
  "studio.signoff.row.reject": "Needs work",
  "studio.signoff.status.approved": "Approved",
  "studio.signoff.status.awaiting": "Awaiting sign-off",
  "studio.signoff.status.rejected": "Rejected — needs work",
